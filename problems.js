...
const problemDatabase = {
    ...
    grade1_language_focus2_question_words: [
        ...
        },
        {
            ...
            exp: "「What music」は「どんな音楽」という意味で、音楽のジャンルや種類について尋ねる表現です。「What」は疑問詞として使われ、具体的な種類や内容を知りたい時に使います。相手の音楽的な好みを知るための質問で、会話のきっかけとしてもよく使われます。「J-pop」は「Japanese pop music」の略です。"
        },
        {
